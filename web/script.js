...
// Функция экспорта для веб-версии (без eel)
function exportToExcelWeb() {
    ...
    // Создаем данные для Excel в формате CSV
    let csvContent = [];
    ...
    let filename = prompt("Введите название файла:", "Итоговая_Ведомость");
    if (!filename) return;
...
// Заменяем функцию экспорта для веб-версии
window.exportToExcel = exportToExcelWeb;
